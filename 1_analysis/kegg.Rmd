...
for (name in comp) {
    ...
    enrichKEGG[[name]]@result$Description <- enrichKEGG[[name]]@result$Description %>% str_to_sentence() %>% str_wrap(width = 45)
...
kegg_id <- c("mmu04612", "mmu04650", "mmu04658","mmu05330","mmu04145")
